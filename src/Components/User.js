    ...
    try {
      ...
      if (data.user && data.user[0]) {
        ...
        if (data.user[0].offers) {
          console.log("data.user.offers", data.user[0].offers);
    ...
    <div className="container mt-5" style={{ paddingBottom: 100 }}>
      ...
      <div className="row">
        ...
        <div className="col-md-8 mt-3">
          {user.company && user.company.name && <h3>{user.company.name}</h3>}
          <h3>
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              <ul className="list-group list-group-flush">
                ...
                <li className="list-group-item">Catégorie : {user.category}</li>
                {user.extra && (
                  <li className="list-group-item">Job : {user.extra.job}</li>
                )}
              </ul>
            </div>
          </div>
        ...
        <React.Fragment>
          ...
          {user.type == "EMPLOYER" && (
            <React.Fragment>
              <h3 style={{ marginTop: 30 }}>
                <span className="badge text-bg-secondary">
                  Annonces de cet utilisateur ({offers.length + missions.length}
                  )
                </span>
              </h3>
              <div
